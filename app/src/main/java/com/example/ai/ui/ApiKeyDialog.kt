    ...
    AlertDialog(
        ...
        text = {
            Column(modifier = Modifier.fillMaxWidth()) {
                Text(
                    text = "Enter your Google Gemini API key to solve math questions, analyze handwriting, and inspect attached documents.",
                    fontSize = 13.sp,
        ...
        dismissButton = {
            TextButton(
                onClick = onDismiss,
                modifier = Modifier.testTag("btn_cancel_api_key")
            ) {
